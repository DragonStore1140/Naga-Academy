...
const rangkumanBindo = [
    ...
    },
    {
        ...
        konten: `
            ...
            <p><strong>Struktur:</strong> Tempat/tanggal → salam pembuka → isi → salam penutup → nama pengirim</p>
            ...
            <p><strong>Struktur:</strong> Kop surat → nomor → lampiran → hal → tanggal → alamat tujuan → salam pembuka → isi → salam penutup → tanda tangan + nama jelas → tembusan</p>
...
const rangkumanMtk = [
    // ========== BILANGAN DAN OPERASI ==========
    {
        ...
        konten: `
            <h3>📌 Pengertian Bilangan Bulat</h3>
            ...
            <h3>➕ Operasi Hitung Bilangan Bulat</h3>
            <ul>
                <li><strong>Penjumlahan:</strong> a + b = c</li>
                <li><strong>Pengurangan:</strong> a - b = a + (-b)</li>
                <li><strong>Perkalian:</strong> a × b = c
                    <br> (+) × (+) = (+)
                    <br> (+) × (-) = (-)
                    <br> (-) × (+) = (-)
                    <br> (-) × (-) = (+)
                </li>
                <li><strong>Pembagian:</strong> a : b = c (b ≠ 0)
                    <br> (+) : (+) = (+)
                    <br> (+) : (-) = (-)
                    <br> (-) : (+) = (-)
                    <br> (-) : (-) = (+)
            ...
            <h3>📊 Sifat-sifat Operasi</h3>
            <ul>
                <li><strong>Komutatif:</strong> a + b = b + a | a × b = b × a</li>
                <li><strong>Asosiatif:</strong> (a + b) + c = a + (b + c) | (a × b) × c = a × (b × c)</li>
                <li><strong>Distributif:</strong> a × (b + c) = (a × b) + (a × c)</li>
                <li><strong>Identitas:</strong> a + 0 = a | a × 1 = a</li>
            </ul>
        `
    },
    {
        ...
        konten: `
            <h3>📌 Pengertian Bilangan Rasional</h3>
            <p>Bilangan yang dapat dinyatakan dalam bentuk a/b, dengan a dan b bilangan bulat, b ≠ 0.</p>
            
            <h3>📋 Contoh Bilangan Rasional</h3>
            <ul>
            ...
            <h3>➕ Operasi Pecahan</h3>
            <ul>
                <li><strong>Penjumlahan:</strong> a/b + c/d = (ad + bc)/bd</li>
                <li><strong>Pengurangan:</strong> a/b - c/d = (ad - bc)/bd</li>
                <li><strong>Perkalian:</strong> a/b × c/d = ac/bd</li>
                <li><strong>Pembagian:</strong> a/b : c/d = a/b × d/c = ad/bc</li>
            </ul>
            
            <h3>📊 Mengurutkan Pecahan</h3>
            <p>Samakan penyebut, lalu bandingkan pembilangnya.</p>
            <p><strong>Contoh:</strong> 2/3 ... 3/4 → 8/12 < 9/12 → 2/3 < 3/4</p>
        `
    },
    {
        ...
        konten: `
            ...
            <p>Bentuk: aⁿ = a × a × a × ... × a (sebanyak n faktor)</p>
            <p><strong>Contoh:</strong> 2³ = 2 × 2 × 2 = 8</p>
            
            <h3>📋 Sifat-sifat Pangkat</h3>
            <ul>
                <li>aᵐ × aⁿ = aᵐ⁺ⁿ</li>
                <li>aᵐ : aⁿ = aᵐ⁻ⁿ (m > n)</li>
                <li>(aᵐ)ⁿ = aᵐ×ⁿ</li>
                <li>(a × b)ⁿ = aⁿ × bⁿ</li>
                <li>(a/b)ⁿ = aⁿ / bⁿ</li>
                <li>a⁰ = 1 (a ≠ 0)</li>
            ...
            <ul>
                <li>a/√b = a/√b × √b/√b = a√b/b</li>
                <li>a/(√b + √c) = a/(√b + √c) × (√b - √c)/(√b - √c)</li>
            </ul>
        `
    },
    ...
    // ========== ALJABAR DAN PERSAMAAN ==========
    {
        ...
        konten: `
            ...
            <ul>
                ...
                <li><strong>Perkalian:</strong> 3x × 2x = 6x²</li>
                <li><strong>Pembagian:</strong> 6x² : 2x = 3x</li>
            </ul>
            
            <h3>📊 Pemfaktoran</h3>
            <ul>
                <li><strong>Faktor Persekutuan:</strong> ax + ay = a(x + y)</li>
                <li><strong>Selisih dua kuadrat:</strong> a² - b² = (a + b)(a - b)</li>
                <li><strong>Kuadrat sempurna:</strong> a² + 2ab + b² = (a + b)²</li>
                <li><strong>Bentuk ax² + bx + c:</strong> cari dua bilangan yang hasil kali = a×c dan jumlah = b</li>
            </ul>
        `
    },
    {
    ...
    },
    {
        ...
        konten: `
            <h3>📌 Persamaan Linear Dua Variabel (PLDV)</h3>
            <p>Bentuk umum: ax + by = c</p>
            <p><strong>Contoh:</strong> 2x + y = 5</p>
            
            <h3>📋 Metode Penyelesaian SPLDV</h3>
            <ul>
            ...
            <h3>📝 Contoh Substitusi</h3>
            <p>2x + y = 5 ...(1)<br>x - y = 1 ...(2)</p>
            <p>Dari (2): x = y + 1<br>Substitusi ke (1): 2(y+1) + y = 5<br>2y + 2 + y = 5<br>3y = 3<br>y = 1, x = 2</p>
            
            <h3>📌 Pertidaksamaan Linear Dua Variabel</h3>
            <p>Bentuk: ax + by < c, ax + by > c, ax + by ≤ c, ax + by ≥ c</p>
    ...
    // ========== POLA DAN FUNGSI ==========
    {
        ...
        konten: `
            ...
            <p>Rumus suku ke-n: Un = a × rⁿ⁻¹</p>
            <p><strong>Contoh:</strong> 2, 6, 18, 54, ... (a=2, r=3)</p>
            
            <h3>📌 Deret Geometri</h3>
            <p>Jumlah n suku pertama:</p>
            <ul>
                <li>Jika r < 1: Sn = a(1 - rⁿ)/(1 - r)</li>
                <li>Jika r > 1: Sn = a(rⁿ - 1)/(r - 1)</li>
            </ul>
            
            <h3>📌 Deret Geometri Tak Hingga</h3>
            <p>S∞ = a/(1 - r), dengan |r| < 1</p>
        `
    },
    {
        ...
        konten: `
            ...
            <p>Notasi: f: A → B atau y = f(x)</p>
            
            <h3>📋 Domain, Kodomain, Range</h3>
            <ul>
    ...
    // ========== GEOMETRI ==========
    {
        ...
        konten: `
            ...
            <h3>📋 Syarat Kesebangunan Segitiga</h3>
            <ul>
    ...
    },
    {
        ...
        konten: `
            <h3>📌 Segi Banyak (Poligon)</h3>
            <p>Bangun datar tertutup yang dibentuk oleh ruas garis.</p>
            
            <h3>📋 Jenis Segi Banyak</h3>
            <ul>
                <li><strong>Segitiga:</strong> 3 sisi, jumlah sudut 180°</li>
                <li><strong>Segiempat:</strong> 4 sisi, jumlah sudut 360°</li>
                <li><strong>Segilima:</strong> 5 sisi, jumlah sudut 540°</li>
                <li><strong>Segienam:</strong> 6 sisi, jumlah sudut 720°</li>
            </ul>
            
            <h3>📌 Lingkaran</h3>
            <p>Himpunan titik-titik yang berjarak sama dari titik pusat.</p>
            
            <h3>📋 Unsur Lingkaran</h3>
            <ul>
                <li><strong>Jari-jari (r):</strong> Jarak pusat ke tepi</li>
                <li><strong>Diameter (d):</strong> 2 × r</li>
            ...
            <ul>
                <li><strong>Keliling:</strong> K = 2πr = πd</li>
                <li><strong>Luas:</strong> L = πr²</li>
                <li><strong>Panjang busur:</strong> = (sudut/360°) × 2πr</li>
                <li><strong>Luas juring:</strong> = (sudut/360°) × πr²</li>
            </ul>
        `
    },
    {
        judul: "Bangun Ruang",
        konten: `
            <h3>📌 BANGUN RUANG SISI DATAR</h3>
            
            <h4>Kubus</h4>
            <p>Rusuk sama panjang, 6 sisi persegi</p>
            <ul>
                <li><strong>Volume:</strong> V = s³</li>
                <li><strong>Luas permukaan:</strong> L = 6s²</li>
                <li><strong>Diagonal sisi:</strong> s√2</li>
                <li><strong>Diagonal ruang:</strong> s√3</li>
            </ul>
            
            <h4>Balok</h4>
            <p>p = panjang, l = lebar, t = tinggi</p>
            <ul>
                <li><strong>Volume:</strong> V = p × l × t</li>
                <li><strong>Luas permukaan:</strong> L = 2(pl + pt + lt)</li>
                <li><strong>Diagonal ruang:</strong> √(p² + l² + t²)</li>
            </ul>
            
            <h4>Prisma</h4>
            <p>Bangun ruang dengan alas dan tutup sama dan sejajar</p>
            <ul>
                <li><strong>Volume:</strong> V = Luas alas × tinggi</li>
                <li><strong>Luas permukaan:</strong> L = (2 × Luas alas) + (Keliling alas × tinggi)</li>
            </ul>
            
            <h4>Limas</h4>
            <p>Bangun ruang dengan alas poligon dan sisi tegak segitiga</p>
            <ul>
                <li><strong>Volume:</strong> V = 1/3 × Luas alas × tinggi</li>
            ...
            <h4>Tabung</h4>
            <ul>
                <li><strong>Volume:</strong> V = πr²t</li>
                <li><strong>Luas selimut:</strong> Ls = 2πrt</li>
                <li><strong>Luas permukaan:</strong> L = 2πr(r + t)</li>
            </ul>
            
            <h4>Kerucut</h4>
            <p>s = garis pelukis = √(r² + t²)</p>
            <ul>
                <li><strong>Volume:</strong> V = 1/3 πr²t</li>
                <li><strong>Luas selimut:</strong> Ls = πrs</li>
                <li><strong>Luas permukaan:</strong> L = πr(r + s)</li>
            </ul>
            
            <h4>Bola</h4>
            <ul>
                <li><strong>Volume:</strong> V = 4/3 πr³</li>
                <li><strong>Luas permukaan:</strong> L = 4πr²</li>
            </ul>
        `
    },
    {
        ...
        konten: `
            ...
            <p>Rumus: (x, y) → (x + a, y + b)</p>
            <p><strong>Contoh:</strong> Titik A(2,3) ditranslasi (4,-1) menjadi A'(6,2)</p>
            
            <h3>📌 Refleksi (Pencerminan)</h3>
            <ul>
                <li><strong>Terhadap sumbu x:</strong> (x, y) → (x, -y)</li>
                <li><strong>Terhadap sumbu y:</strong> (x, y) → (-x, y)</li>
                <li><strong>Terhadap garis y = x:</strong> (x, y) → (y, x)</li>
                <li><strong>Terhadap garis y = -x:</strong> (x, y) → (-y, -x)</li>
                <li><strong>Terhadap titik asal (0,0):</strong> (x, y) → (-x, -y)</li>
            </ul>
            
            <h3>📌 Rotasi (Perputaran)</h3>
            <ul>
                <li><strong>90° searah jarum jam (270°):</strong> (x, y) → (y, -x)</li>
                <li><strong>90° berlawanan jarum jam:</strong> (x, y) → (-y, x)</li>
                <li><strong>180°:</strong> (x, y) → (-x, -y)</li>
                <li><strong>270° searah jarum jam (90°):</strong> (x, y) → (-y, x)</li>
            </ul>
            
            <h3>📌 Dilatasi (Perkalian)</h3>
            <p>Memperbesar/memperkecil dengan faktor skala k</p>
            <ul>
                <li><strong>Pusat (0,0):</strong> (x, y) → (kx, ky)</li>
                <li><strong>Pusat (a,b):</strong> (x, y) → (a + k(x-a), b + k(y-b))</li>
            </ul>
        `
    },
    {
        ...
        konten: `
            ...
            <h3>📋 Perbedaan Kongruen dan Sebangun</h3>
            <ul>
            ...
            <h3>📌 Syarat Kekongruenan Segitiga</h3>
            <ul>
            ...
            <p>AB = DE, BC = EF, AC = DF, dan ∠A = ∠D, ∠B = ∠E, ∠C = ∠F</p>
        `
    }, 
    {
    ...
    konten: `
        ...
        <ul>
            ...
            <li><strong>Keliling:</strong> K = 4 × s</li>
            <li><strong>Luas:</strong> L = s × s = s²</li>
        ...
        <ul>
            ...
            <li><strong>Keliling:</strong> K = 2 × (p + l)</li>
            <li><strong>Luas:</strong> L = p × l</li>
            <li><strong>Diagonal:</strong> d = √(p² + l²)</li>
        </ul>
        ...
        <ul>
            ...
            <li><strong>Luas:</strong> L = ½ × a × t</li>
        </ul>
        <p><em>Catatan: Segitiga tidak memiliki diagonal karena hanya punya 3 sisi.</em></p>
        
        <h5>Jenis Segitiga:</h5>
        <ul>
            <li><strong>Siku-siku:</strong> a² + b² = c² (c = sisi miring)</li>
            <li><strong>Sama sisi:</strong> K = 3s, L = (√3/4) × s²</li>
        ...
        <ul>
            ...
            <li><strong>Keliling:</strong> K = 2 × (a + b)</li>
            <li><strong>Luas:</strong> L = a × t</li>
        </ul>
        ...
        <ul>
            <li><strong>Sisi:</strong> s, <strong>Diagonal 1:</strong> d₁, <strong>Diagonal 2:</strong> d₂</li>
            <li><strong>Keliling:</strong> K = 4 × s</li>
            <li><strong>Luas:</strong> L = ½ × d₁ × d₂</li>
            <li><strong>Hubungan sisi dan diagonal:</strong> s = ½√(d₁² + d₂²)</li>
        </ul>
        
        <h4>6. Layang-layang</h4>
        <ul>
            <li><strong>Diagonal 1:</strong> d₁, <strong>Diagonal 2:</strong> d₂</li>
        ...
        <ul>
            ...
            <li><strong>Luas:</strong> L = ½ × (a + b) × t</li>
        </ul>
